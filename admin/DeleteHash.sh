...
APP_HOME=/ums/fq/src/DelHash
PROCESS=DeleteHash
APP_CONF=DeleteHash.conf
...
then
    ...
    echo "       start : START DeleteHash."
    echo "       bstart : background START DeleteHash."
    echo "       stop  : STOP DeleteHash."
    echo "       kill  : KILL DeleteHash immediately."
    exit
fi
