...
PROCESS=fq_agent_threads_json
APP_CONF=fq_agent_threads_json.conf
...
then
    ...
    echo "       start : START handler_svr_json ."
    echo "       bstart : background START handler_svr_json ."
    echo "       stop  : STOP handler_svr_json ."
    echo "       kill  : KILL handler_svr_json immediately."
    exit
fi
