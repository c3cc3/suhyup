/*
** Description: This program deletes an item to Heartbeat Table.
** del_heartbeat_table.c
*/
...
int main(int ac, char **av)
{
	...
	sprintf(logname, "./%s.log", "del_heartbeat_table");
	...
	rc = obj->on_del_table(l, obj, distname, progname, hostname);
	if( rc == FALSE) {
		fq_log(l, FQ_LOG_ERROR, "on_del_table() failed.");
	}
