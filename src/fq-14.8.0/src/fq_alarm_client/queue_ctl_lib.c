...
bool Open_takeout_Q( fq_logger_t *l, fq_alarm_client_conf_t *conf, fqueue_obj_t **deq_obj)
{
	int rc;
...
int takeout_uchar_msg_from_Q(fq_logger_t *l, fq_alarm_client_conf_t *my_conf, fqueue_obj_t *deq_obj, unsigned char **msg, char **uf, long *p_seq)
{
	long l_seq=0L;
