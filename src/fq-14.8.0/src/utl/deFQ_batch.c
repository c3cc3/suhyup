...
#define QNAME "TST"
#define LOG_FILE_NAME "deFQ_batch.log"
...
{  
	...
	while(1) {
		unsigned char *dst[ARRAY_BUFFER_LEN];
		long run_time=0L;
		int data_count = 0;

		data_count = obj->on_de_bundle_array(l, obj, ARRAY_BUFFER_LEN, MAX_DATA_LEN, dst, &run_time);
