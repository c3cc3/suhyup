 ...
 *    
 */
#ifndef FQ_TLPI_HDR_H
#define FQ_TLPI_HDR_H      /* Prevent accidental double inclusion */
...
#include "fq_get_num.h"    /* Declares our functions for handling numeric
                           arguments (getInt(), getLong()) */

#include "fq_error_functions.h"  /* Declares our error-handling functions */
