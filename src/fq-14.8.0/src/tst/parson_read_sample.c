...
int main()
{
    ...
    printf("Student.grade: %s\n", json_object_dotget_string(rootObject, "Student.grade"));
    printf("Student.class: %s\n", json_object_dotget_string(rootObject, "Student.class"));
    ...
    for (i = 0; i < json_array_get_count(array); i++)     // 배열의 요소 개수만큼 반복
    {
